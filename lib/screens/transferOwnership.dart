...
class _transferOwnershipState extends State<transferOwnership> {
  ...
  getProfileInfo() async {
    ...
    if (connectedWithMetamask)
      assetInfo = await model2.assetInfo(BigInt.parse(widget.assetId));
    else
      assetInfo = await model.assetInfo(BigInt.parse(widget.assetId));
              ...
              child: Column(
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      assetWid3(
                        assetInfo[9].toString(),
                        assetInfo[1].toString(),
                        assetInfo[2],
                        assetInfo[3].toString(),
                        assetInfo[5].toString(),
                        assetInfo[6].toString(),
                        assetInfo[7].toString(),
                      ),
                      takeWitnessInfo()
                    ],
                  ),
