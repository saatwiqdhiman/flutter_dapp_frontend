...
import 'package:asset_registration/providers/MetamaskProvider.dart';
...
import '../providers/assetRegisterModel.dart';
...
class _CheckPrivateKeyState extends State<CheckPrivateKey> {
  ...
  Widget build(BuildContext context) {
    var model = Provider.of<assetRegisterModel>(context);
                    ...
                    : () async {
                        if (_formKey.currentState!.validate()) {
                          ...
                          try {
                            ...
                            } else if (widget.val == "assetInspector") {
                              bool temp =
                                  await model.isassetInspector(privatekey);
                              if (temp == false) {
                                setState(() {
                                  errorMessage = "You are not authrosied";
                                });
                ...
                if (model2.isConnected && model2.isInOperatingChain) {
                  ...
                  if (widget.val == "owner") {
                    ...
                    if (temp == false) {
                      ...
                      //     context,
                      //     MaterialPageRoute(
                      //         builder: (context) => const AddassetInspector()));
                      Navigator.of(context).pushNamed(
                        '/contractowner',
                      );
                    }
                    ...
                    bool temp = await model2.isassetInspector();
                    if (temp == false) {
                      setState(() {
                        errorMessage = "You are not authrosied";
                      });
                      ...
                      //     context,
                      //     MaterialPageRoute(
                      //         builder: (context) => const assetInspector()));
                      Navigator.of(context).pushNamed(
                        '/assetinspector',
                      );
                    }
